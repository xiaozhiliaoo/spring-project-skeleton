...
public class RequestUtils {
	...
	public static String getQueryParam(HttpServletRequest request, String name) {
		...
		try {
			s = URLDecoder.decode(s, Charsets.UTF_8.toString());
		} catch (UnsupportedEncodingException e) {
			log.error("encoding " + Charsets.UTF_8.toString() + " not support?", e);
		}
	 ...
	 * @return
	 */
	public static String getRequestJsonStr(ServletRequest request) {
